    ...
    <div className="marketing-page-container">
      <header id="hero">
        ...
        <div className="hero-actions">
          <Link to="/register" className="button button-primary button-lg">Get started</Link>
        </div>
      </header>
      ...
      <ContentCarousel title="Featured Artworks" data={featuredArtworks} isLoading={isLoadingArtworks} renderCard={item => <ArtworkCard item={item} />} />
      <section className="marketing-section">
        <h2 className="text-center">Powerful Tools, Effortless Management</h2>
        <div className="features-grid">
          <FeatureCard icon={<Palette size={32} />} title="Inventory Management">A complete, professional system to track your entire collection, including editions, sales history, and private notes.</FeatureCard>
          <FeatureCard icon={<BarChart size={32} />} title="Sales & Insights">Monitor your sales, view revenue analytics, and understand which pieces are getting the most attention from collectors.</FeatureCard>
          <FeatureCard icon={<MessageSquare size={32} />} title="Direct Communication">A built-in messaging center to handle inquiries directly, negotiate sales, and build relationships with your buyers.</FeatureCard>
          <FeatureCard icon={<ShieldCheck size={32} />} title="Secure & Private">You control what's public. Share private catalogues with specific contacts or keep your entire inventory private.</FeatureCard>
        </div>
      </section>

      <ContentCarousel title="Featured Catalogues" data={featuredCatalogues} isLoading={isLoadingCatalogues} renderCard={item => <CatalogueCard item={item} />} />
      <section className="marketing-section testimonials">
        <h2 className="text-center">Trusted by Artists and Collectors</h2>
        <div className="testimonial-grid">
          <TestimonialCard quote="ArtFlow has become the backbone of my studio practice. I spend less time on admin and more time creating." author="Elena Vance" title="Contemporary Painter" />
          <TestimonialCard quote="As a collector, the ability to view curated catalogues and inquire directly with the artist is a game-changer." author="Marcus Thorne" title="Private Collector" />
        </div>
      </section>
      <ContentCarousel title="Featured Artists" data={featuredArtists} isLoading={isLoadingArtists} renderCard={item => <ArtistCard item={item} />} />
