...
type ArtworkRecommendation = (Database['public']['Functions']['get_similar_artworks']['Returns'] & {})[number];
...
const CollectorDashboardPage = () => {
    ...
    return (
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem' }}>
                ...
                {recommendedLoading ? <p>Loading...</p> : (
                    <div className="horizontal-scroll-row">
                        {recommendedArtworks.map(a => (
                            <Link key={a.id} to={`/${a.artist_slug}/artwork/${a.slug}`} className="scroll-card">
            ...
            <div className="widget">
                <h3>Things We Think You’ll Like</h3>
                {recommendedLoading ? <p>Loading...</p> : (
                    <div className="horizontal-scroll-row">
                        {recommendedArtworks.map(a => (
                            <Link key={a.id} to={`/${a.artist_slug}/artwork/${a.slug}`} className="scroll-card">
