...
type Artwork = ArtworkRow & {
  artist?: ProfileRow | null; // Joined artist profile data
  artwork_images?: ArtworkImage[]; // Joined artwork images
      ...
      <fieldset className="fieldset">
        ...
        {!!artwork.has_certificate_of_authenticity && (
          <TextField
            ...
            onChange={handleFormChange}
            onBlur={() => setTouched(prev => ({ ...prev.certificate_of_authenticity_details, certificate_of_authenticity_details: true } ))} // Corrected onBlur path
